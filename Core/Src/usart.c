...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspInit 0 */
    ...
    PB13     ------> UART5_TX
    */
    GPIO_InitStruct.Pin = OPT_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF14_UART5;
    HAL_GPIO_Init(OPT_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = LMOD_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF14_UART5;
    HAL_GPIO_Init(LMOD_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END UART7_MspInit 0 */
    ...
    PF7     ------> UART7_TX
    */
    GPIO_InitStruct.Pin = NEX_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_UART7;
    HAL_GPIO_Init(NEX_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = NEX_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_UART7;
    HAL_GPIO_Init(NEX_TX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PB13     ------> UART5_TX
    */
    HAL_GPIO_DeInit(GPIOB, OPT_RX_Pin|LMOD_TX_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PF7     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOF, NEX_RX_Pin|NEX_TX_Pin);
...
//  TxDMA = 1;
//  //LED_R(1);
//  HAL_UART_Transmit_DMA(&huart3, (void*)Str_mas,strlen((void*)Str_mas)); // выдаем 
//  //HAL_UART_Transmit(&huart3, (void*)Str_mas,strlen((void*)Str_mas),100); // выдаем 
//  //HAL_Delay(100);
//  //TxDMA = 0;
//  //LED_R(0);
//  }
