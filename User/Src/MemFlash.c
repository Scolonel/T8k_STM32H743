    ...
    if(res == FR_OK)
    {
      while(1)
      {
        ...
        //1) есть в нужном месте _ и .sor
          if((strlen(fn) == 17)&&(fn[6]=='_')&&(fn[13]=='.')&&(fn[14]=='t')&&(fn[15]=='8')&&(fn[16]=='k')) // наш размер теперь проверим содержимое
          {
            ...
            //{
              memcpy( &NameFiles[NumNameFiles],fn,17);
              NameFiles[NumNameFiles][17]=0;
              NumNameFiles++;
